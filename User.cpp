...
std::string User::toString()
{
    return std::string().append("学号：").append(this->sno)
        .append(" 姓名：").append(this->name)
        .append(" 加入时间：").append(this->join_date_time);
}

User::User(const std::string &sno, const std::string &name, const std::string &joinDateTime) : sno(sno), name(name),
                                                                                               join_date_time(
                                                                                                       joinDateTime) {}
